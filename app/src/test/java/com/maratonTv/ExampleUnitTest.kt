...
import com.maratonTv.data.SeriesMetroScraper
...
class ExampleUnitTest {
  ...
  fun testPoseidonHDScraperList() = kotlinx.coroutines.runBlocking {
    ...
    val items = com.maratonTv.data.PelisPlusScraper.scrapeList()
  ...
  fun testPoseidonHDScraperSearch() = kotlinx.coroutines.runBlocking {
    ...
    val items = com.maratonTv.data.PelisPlusScraper.scrapeList(query = "rebelde")
  ...
  fun testPoseidonHDScraperDetailSeries() = kotlinx.coroutines.runBlocking {
    ...
    val detail = com.maratonTv.data.PelisPlusScraper.scrapeDetail(url)
  ...
  fun testPoseidonHDScraperChapterDetail() = kotlinx.coroutines.runBlocking {
    ...
    val capDetail = com.maratonTv.data.PelisPlusScraper.scrapeCapituloDetail(url)
    ...
    capDetail.embedUrls.forEach { embed ->
        ...
        val resolved = com.maratonTv.data.PelisPlusScraper.resolveDirectVideoIframe(embed)
        val server = com.maratonTv.data.PelisPlusScraper.getServerName(resolved)
